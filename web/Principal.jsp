...
<html>
    ...
    <body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="dropdown">
                <button style="borde:none" class="btn btn-outline-light dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ${usuario.getNom()}
                </button>
                <div class="dropdown-menu text-center" >
                  <a class="dropdown-item" href="#"></a>
                  <img src="img/download.jpg" alt="60" width="60"/>
                  <a class="dropdown-item" href="#">${usuario.getUsser()}</a>
                  <a class="dropdown-item" href="#"> usuario@gmail.com</a>
                  <div class="dropdown-divider"></div>
                  <form actio="Validar" method="POST">
